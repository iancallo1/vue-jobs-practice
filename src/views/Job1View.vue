...
onMounted(async () => {
    try {
      ...
      state.error = 'Job not found or server error';
    } finally {
...
<template>
    ...
    <section v-if="!state.isloading" class="bg-green-50">
      <div v-if="state.error" class="container m-auto py-10 px-6">
    ...
    <!-- Loading Spinner -->
    <div v-else class="text-center text-gray-500 items-center py-6">
      <BounceLoader />
    </div>
